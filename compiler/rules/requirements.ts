...
const knownFlags: Record<string, Predicate> = {
  ...
  default_parameter: eq('parameter.default', true),
  rest_parameter: eq('parameter.rest', true),
  inside_non_arrow_function: eq('function.kind', 'ordinary'),
  arguments_binding_not_shadowed: eq('arguments.binding', 'implicit'),
  length_property_unmodified: eq('arguments.lengthIntegrity', 'pristine'),
  arguments_object_unmapped: eq('arguments.mapping', 'unmapped'),
  spread_in_call: eq('call.spread', true),
