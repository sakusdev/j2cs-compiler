...
const knownFlags: Record<string, Predicate> = {
  ...
  constructor_is_ordinary_js_function: eq('constructor.kind', 'ordinary'),
  ordinary_constructor: eq('constructor.kind', 'ordinary'),
  constructable: eq('constructor.constructable', true),
  constructor_may_return_object: eq('constructor.returnObject', true),
  inside_function_or_class: eq('meta.insideFunction', true),
