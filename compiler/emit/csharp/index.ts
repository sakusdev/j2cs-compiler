...
const calls = new Set(['JsValue.IsTruthy', 'JsOperators.Add', 'JsOperators.StrictEquals', 'JsOperators.LooseEquals',
  ...
  'JsObject.SetProperty', 'JsObject.HasOwn', 'JsArray.Create', 'JsArray.DefineElement', 'JsArray.Length', 'JsArray.Push', 'JsArguments.Get', 'JsArguments.Empty', 'JsArguments.Create', 'JsArguments.Rest', 'JsArguments.Length']);
