...
export const ELECTRON_IPC_PRELOAD_RULES: readonly ElectronIpcPreloadRuleSpec[] = [
  {
    ...
    strategy: 'runtime',
    runtimeContract: 'IpcMainRouter.Handle',
    area: 'ipc',
    needsCallback: true,
  },
  {
    ...
    category: 'electron.ipc',
    strategy: 'runtime',
    runtimeContract: 'IpcMainRouter.HandleOnce',
    area: 'ipc',
    needsCallback: true,
  },
  {
    ...
    category: 'electron.ipc',
    strategy: 'runtime',
    runtimeContract: 'IpcMainRouter.RemoveHandler',
    area: 'ipc',
  },
  {
    ...
    category: 'electron.ipc',
    strategy: 'runtime',
    runtimeContract: 'IpcMainRouter.On',
    area: 'ipc',
    needsCallback: true,
  },
  {
    ...
    category: 'electron.ipc',
    strategy: 'runtime',
    runtimeContract: 'IpcRendererEndpoint.InvokeAsync',
    area: 'ipc',
    needsArguments: true,
  },
  {
    ...
    category: 'electron.ipc',
    strategy: 'runtime',
    runtimeContract: 'IpcRendererEndpoint.Send',
    area: 'ipc',
    needsArguments: true,
  },
  {
    ...
    category: 'electron.ipc',
    strategy: 'runtime',
    runtimeContract: 'IpcWebContentsEndpoint.Send',
    area: 'ipc',
    needsArguments: true,
  },
  {
  ...
  },
  {
    ...
    category: 'electron_preload_context',
    strategy: 'runtime',
    runtimeContract: 'ContextBridge.ExposeInMainWorld',
    area: 'contextBridge',
