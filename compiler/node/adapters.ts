...
export const NODE_COMPAT_ADAPTERS: readonly NodeCompatAdapter[] = [
  ...
  { ruleId: 'node.stream.readable.push-eof', sha256: '57efdb1b07dff47c06aaa7685825f81d905907c183647d553376b88c2f68e8e9', helper: 'NodeStreams.PushEof', requires: [schedulerCompatible] },
  { ruleId: 'node.stream.readable.read', sha256: 'f7050150bb4d332b959c764535851fb7669eacd40fe250ba835f8a8e75f2b62e', helper: 'NodeStreams.Read', requires: [schedulerCompatible] },
  { ruleId: 'node.stream.writable.write', sha256: '1910bc5207ef3f102c0bd3f0a9824d75c7d4574058d749fb03b782963e46d2ea', helper: 'NodeStreams.Write', requires: [schedulerCompatible] },
  { ruleId: 'node.stream.writable.end', sha256: 'ed2d8430df786aa055b96cb320dfccabf57218122e571613df0d1cbb489eccdf', helper: 'NodeStreams.End', requires: [schedulerCompatible] },
  { ruleId: 'node.stream.writable.drain', sha256: '06ed7a21bdd228041b56908c0e367c1671cb1e4b102eeabd5e5c09f28cc8c9df', helper: 'NodeStreams.OnDrain', requires: [schedulerCompatible] },
  { ruleId: 'node.stream.writable.finish', sha256: 'a423f29ceace75c7c4bbffa79aae15ce0d21b3dd26145e0a3c0dc124e05e2d7b', helper: 'NodeStreams.OnFinish', requires: [schedulerCompatible] },
  { ruleId: 'node.stream.duplex.constructor', sha256: 'c3aa992608e7d69483960078defd83f0c8999dae9a1614ffce896c1451912f74', helper: 'NodeStreams.CreateDuplex', requires: [schedulerCompatible] },
